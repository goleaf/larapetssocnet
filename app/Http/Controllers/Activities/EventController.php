...
class EventController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('activities.events.index', [
            'events' => $events,
    ...
    public function show(Request $request, string $event): View
    {
        ...
        return view('activities.events.show', [
            'event' => $eventModel,
            'group' => $group,
            'creator' => $creator,
            'attendees' => $attendees,
    ...
    public function create(Request $request): View
    {
        ...
        return view('activities.events.create', [
            'event' => new Event,
            'groups' => $groups,
    ...
    public function edit(Request $request, string $event): View
    {
        ...
        return view('activities.events.edit', [
            'event' => $eventModel,
            'groups' => $groups,
    ...
    public function downloadIcs(Request $request, string $event): ResponseFactory|Response
    {
        $eventModel = $this->resolveEvent($event);
        $viewer = $request->user();
    ...
    protected function buildEventPayload(array $validated, int $creatorId, ?Event $existing = null): array
    {
        ...
        $payload = [
            ...
            $endColumn => empty($validated['ends_at']) ? null : Carbon::parse($validated['ends_at']),
            $locationColumn => $validated['location'] ?? null,
        ];

        if ($statusColumn) {
            $payload[$statusColumn] = $existing instanceof Event
    ...
    {
        if (! $viewer instanceof Authenticatable) {
            return false;
        }
