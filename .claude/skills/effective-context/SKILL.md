...
### Laravel Context
- **Version**: "Laravel 13.12.0 on PHP 8.5 locally, Composer PHP ^8.4" plus relevant package versions
...
GOOD: "Getting error when creating user:
  ...
  Using Laravel 13 with MySQL 8.0"
```
