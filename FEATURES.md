...
- Project skill guidance is exposed through root `skills.md`, `skills/skill-map.md`, compact local routers, and the project-installed Superpowers Laravel pack under `.claude/skills` instead of one exposed Codex skill per detailed guide.
