...
- This project runs Tailwind after Sass through `@tailwindcss/postcss`.
- Prefer CSS-first theme variables and only add JavaScript configuration when the project already needs it.
- Import Tailwind from the stylesheet entry point:
