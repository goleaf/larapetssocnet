...
<nav class="sticky top-0 z-40 border-b surface-glass"style="border-color: var(--ui-border);">
 ...
 <a href="{{ Auth::check() && Route::has('feed.index') ? route('feed.index') : (Route::has('explore.index') ? route('explore.index') : url('/')) }}"
 class="flex shrink-0 items-center gap-2">
 <span class="inline-flex h-9 w-9 items-center justify-center rounded-xl text-lg"
 style="background: color-mix(in srgb, var(--ui-primary) 16%, var(--ui-surface) 84%);">🐾</span>
 ...
 <svg class="h-5 w-5"viewBox="0 0 20 20"fill="none"stroke="currentColor"stroke-width="1.7">
 <path
 d="M10 3.4a4.2 4.2 0 0 1 4.2 4.2v2.2c0 .9.3 1.7.9 2.4l.8.9H4.1l.8-.9c.6-.7.9-1.5.9-2.4V7.6A4.2 4.2 0 0 1 10 3.4Z"
 stroke-linejoin="round"/>
 ...
 <a href="{{ route('follow-requests.index') }}"
 class="rounded-full border border-amber-300 bg-amber-50 px-3 py-1.5 text-xs font-medium text-amber-700 transition-colors hover:bg-amber-100"
