...
@if ($suggestions->count())
    <aside class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <h3 class="mb-3 text-sm font-semibold text-gray-900 dark:text-white">Who to Follow</h3>
        ...
        <a href="{{ route('explore.index') }}" class="mt-3 block text-center text-xs text-emerald-600 hover:underline dark:text-emerald-400">
