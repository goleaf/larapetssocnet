...
@if ($suggestions->count())
 ...
 <h3 class="mb-3 text-sm font-semibold text-gray-900">Who to Follow</h3>
 ...
 <a href="{{ route('profile.show', ['user'=> $suggested]) }}"class="block truncate text-xs font-medium text-gray-900 hover:underline">{{ $suggested->name }}</a>
