...
<span data-ui="profile-verified-badge" class="relative inline-flex shrink-0 align-middle" x-data="{ open: false }">
 <button type="button"
 class="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#0F9F8C]/10 text-[#0F9F8C] ring-1 ring-[#0F9F8C]/25 transition-colors hover:bg-[#0F9F8C]/15 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0F9F8C]"
 ...
 x-cloak
 x-transition
 class="absolute left-1/2 top-9 z-30 w-64 -translate-x-1/2 rounded-[var(--radius-soft)] border border-[#0F9F8C]/25 bg-warm-white px-3 py-2 text-xs font-medium text-bark shadow-card">
 {{ $verificationCopy }}
 </span>
</span>
