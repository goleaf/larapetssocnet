<div class="rounded-2xl border border-gray-200 bg-white p-3" x-data="{ expanded: false }">
 ...
 <button type="button" class="w-full rounded-full border border-gray-200 px-4 py-2 text-left text-sm text-gray-400" @click="expanded = true">What's on your mind?</button>
 </div>
 ...
 <button type="button" class="text-sm text-gray-400 hover:text-gray-400" @click="expanded = false">Cancel</button>
 </div>
 </div>
</div>
