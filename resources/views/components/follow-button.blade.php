...
<div
    x-data="{
        ...
        get btnStyle() {
            if (this.status === 'following') return 'bg-white border border-gray-300 text-gray-700 hover:border-red-400 hover:text-red-500 hover:bg-red-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300'
            if (this.status === 'pending') return 'bg-gray-100 border border-gray-300 text-gray-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400'
