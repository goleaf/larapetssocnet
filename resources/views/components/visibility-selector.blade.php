...
@php
    $options = [
        'public' => [
            ...
            'ring' => 'ring-emerald-500 bg-emerald-50 dark:bg-emerald-900/20',
        ],
        'followers' => [
            'icon' => '👥',
            'label' => 'Followers',
            'sub' => 'Only your followers can see this',
            'ring' => 'ring-blue-500 bg-blue-50 dark:bg-blue-900/20',
        ],
        'private' => [
            'icon' => '🔒',
            'label' => 'Only me',
            'sub' => 'Only you can see this',
            'ring' => 'ring-gray-400 bg-gray-100 dark:bg-gray-800',
        ],
    ];
...
>
    ...
    @foreach($options as $value => $option)
        <button
            ...
            :class="selected === '{{ $value }}'
                ? '{{ $option['ring'] }} ring-2'
                : 'bg-white ring-1 ring-gray-200 hover:ring-gray-300 dark:bg-gray-900 dark:ring-gray-700 dark:hover:ring-gray-600'"
        ...
        >
            ...
            <span class="min-w-0 flex-1">
                ...
                <span class="block text-xs text-gray-500 dark:text-gray-400">{{ $option['sub'] }}</span>
            </span>
            <span
                :class="selected === '{{ $value }}'
    ...
    <div
        ...
        class="flex items-start gap-2 rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm text-amber-700 dark:border-amber-700 dark:bg-amber-900/20 dark:text-amber-300"
        style="display: none;"
    >
