...
>
 <button type="button" class="rounded-md px-2 py-1 text-sm text-gray-400 hover:bg-gray-100" @click="react('love')">❤️ <span x-text="total"></span></button>
 <button type="button" class="rounded-md px-2 py-1 text-sm text-gray-400 hover:bg-gray-100" @click="showPicker = !showPicker">+</button>
