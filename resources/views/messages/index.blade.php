...
<x-app-layout>
    <x-slot name="header">
        <x-ui.page-header
            title="Messages"
            subtitle="Simple inbox, newest conversations first."
            :breadcrumbs="[
                ['label' => 'Messages'],
            ]"
            icon="💬"
                            ...
                            <div class="flex items-center justify-between gap-3">
                                <div class="flex min-w-0 items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="truncate text-xs text-fur">{{ $peer->username ? '@'.$peer->username : 'Pet lover' }}</p>
                                        <p class="mt-0.5 truncate text-sm {{ $isUnread ? 'font-medium text-bark' : 'text-fur' }}">{{ $preview }}</p>
                                    </div>
                                </div>
