    ...
    <div class="space-y-5">
        ...
        <x-ui.card>
            <form method="GET" action="{{ route('events.index') }}" class="grid gap-3 md:grid-cols-12">
                ...
                <div class="flex items-end md:col-span-2">
                    <x-ui.button :href="route('events.index')" variant="ghost" size="sm" class="w-full">Reset</x-ui.button>
                </div>
            </form>
        </x-ui.card>
            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                @foreach ($events as $event)
                    ...
                    <x-ui.card>
                        ...
                        <div class="mt-4">
                            <x-ui.button :href="route('events.show', $event->id)" variant="primary" size="sm" class="w-full">View Event</x-ui.button>
                        </div>
                    </x-ui.card>
                @endforeach
            </div>
