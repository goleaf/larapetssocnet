        ...
        <aside class="space-y-4 xl:sticky xl:top-24 xl:self-start">
            <x-ui.card padding="base">
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-xs font-bold uppercase tracking-wider text-fur">Your Groups</p>
                    <a href="{{ route('groups.index', ['privacy' => 'joined']) }}"
                        class="text-xs font-semibold text-paw hover:underline">Browse</a>
                </div>
                ...
                <div class="space-y-2.5">
                    ...
                    @empty
                        <p class="text-sm text-fur">You have not joined any groups yet.</p>
                    @endforelse
                </div>
