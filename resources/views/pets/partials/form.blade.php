...
<div class="space-y-6">
 ...
 placeholder="playful, curious, friendly"
  />
 <p class="mt-1 text-xs text-gray-400">Comma-separated tags.</p>
 ...
 class="mt-1 block w-full rounded-md border border-gray-300 p-2 text-sm file:mr-3 file:rounded-md file:border-0 file:bg-indigo-50 file:px-3 file:py-1.5 file:text-indigo-700 hover:file:bg-indigo-100"
  />
 <p class="mt-1 text-xs text-gray-400">Upload up to 30 photos, max 5MB each.</p>
 ...
 <span class="text-sm text-gray-400">Available for adoption</span>
 </label>
 ...
 <span class="text-sm text-gray-400">Mark as deceased (Rainbow Bridge)</span>
 </label>
 </div>
</div>
