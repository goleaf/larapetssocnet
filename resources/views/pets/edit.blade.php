<x-app-layout>
 ...
 <a href="{{ route('pets.show', $pet->slug ?? $pet->getKey()) }}" class="text-sm text-gray-400 hover:text-gray-400">Back to profile</a>
 </div>
 </form>
 </div>
 </div>
 ...
 <p class="mt-2 text-sm text-gray-400">Delete this pet profile (soft delete).</p>
