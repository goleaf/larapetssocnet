<x-app-layout>
 ...
 class="group flex items-center text-sm font-semibold text-gray-400 hover:text-gray-400 transition-colors">
 ...
 <span
 class="inline-flex items-center rounded-full px-3 py-1 text-xs font-bold uppercase tracking-wider ring-1 ring-inset
 {{ $listing->status === \App\Models\MarketplaceListing::STATUS_ACTIVE ?'bg-emerald-100/80 text-emerald-800 ring-emerald-600/20':'bg-gray-100/80 text-gray-400 ring-gray-600/20'}}">
 {{ $listing->status }}
 </span>
 </div>
 <h1 class="text-3xl sm:text-5xl font-extrabold text-gray-400 tracking-tight leading-tight">
 {{ $listing->title }}</h1>
 <div class="mt-6 flex flex-wrap items-center text-gray-400 text-sm font-medium gap-6">
 ...
 <h2 class="text-2xl font-extrabold text-gray-400 mb-6 flex items-center">
 ...
 <div class="prose prose-lg prose-blue max-w-none text-gray-400 leading-relaxed font-medium">
 ...
 <div class="mt-4">
 <h3 class="text-xl font-extrabold text-gray-400 leading-none">
 ...
 <p class="mt-3 text-sm text-gray-400 leading-relaxed font-semibold">
 ...
 @csrf
 <button type="submit"
 class="group w-full inline-flex justify-center items-center gap-2 rounded-xl bg-gray-100 text-white px-4 py-3.5 text-sm font-bold hover:bg-gray-100 transition-all shadow-md hover:shadow-lg focus:ring-2 focus:ring-gray-900/20 focus:outline-none focus:ring-offset-2">
 ...
 @else
 <a href="{{ route('login') }}"
 class="w-full inline-flex justify-center items-center gap-2 rounded-xl bg-gray-100 text-white px-4 py-3.5 text-sm font-bold hover:bg-gray-100 transition-colors shadow-md">
