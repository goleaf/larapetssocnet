                    ...
                    <div>
                        <div class="flex flex-wrap items-center gap-3 mb-4">
                            ...
                            <span
                                ...
                                {{ $listing->status === \App\Models\MarketplaceListing::STATUS_ACTIVE ? 'bg-emerald-100/80 text-emerald-800 ring-emerald-600/20' : 'bg-gray-100/80 text-gray-800 ring-gray-600/20' }}">
                                {{ $listing->status }}
                            </span>
                        </div>
