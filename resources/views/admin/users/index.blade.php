...
@section('content')
 ...
 <h1 class="text-2xl font-bold text-gray-400">👤 Manage Users</h1>
 ...
 <tr>
 <th class="px-4 py-3 text-left font-medium text-gray-400">User</th>
 <th class="px-4 py-3 text-left font-medium text-gray-400">Email</th>
 <th class="px-4 py-3 text-left font-medium text-gray-400">Role</th>
 <th class="px-4 py-3 text-left font-medium text-gray-400">Status</th>
 <th class="px-4 py-3 text-left font-medium text-gray-400">Joined</th>
 </tr>
 </thead>
