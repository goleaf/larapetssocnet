<x-app-layout>
 ...
 <h3 class="mb-2 text-sm font-semibold text-gray-400">{{ __('en.tagged_pets') }}</h3>
 ...
 <h3 class="font-bold text-gray-400 text-lg">{{ __('en.comments') }} <span
 class="text-gray-400 font-normal text-base ml-1">({{ $post->comments_count }})</span></h3>
 </div>
 </x-slot>
 ...
 class="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-2.5 pr-12 text-sm text-gray-400 placeholder-gray-500 focus:bg-white focus:border-paw focus:ring-1 focus:ring-paw resize-none overflow-hidden"
 placeholder="{{ __('en.write_a_comment') }}"
 ...
 <p class="text-gray-400 text-sm">{{ __('en.no_comments_yet_be_the_first_to_share_your_thoughts') }}</p>
 </div>
 @else
 <div class="space-y-4">
