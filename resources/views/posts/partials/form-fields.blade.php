...
<div class="space-y-4">
 <div>
 <label for="body" class="block text-sm font-medium text-gray-400">Body</label>
 <textarea
 id="body"
 name="body"
 rows="6"
 ...
 <div>
 <label for="visibility" class="block text-sm font-medium text-gray-400">Visibility</label>
 ...
 <div>
 <label for="tagged_pets" class="block text-sm font-medium text-gray-400">Tag Pets</label>
 @php
 ...
 <p class="mt-1 text-xs text-gray-400">Hold Ctrl/Cmd to select multiple pets.</p>
 @error('tagged_pets')
 <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
 @enderror
 @error('tagged_pets.*')
 ...
 <div class="grid gap-4 sm:grid-cols-2">
 <div>
 <label for="photos" class="block text-sm font-medium text-gray-400">Photos (multiple)</label>
 <input id="photos" name="photos[]" type="file" accept="image/*"multiple class="mt-1 block w-full text-sm text-gray-400">
 @error('photos')
 <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
 @enderror
 @error('photos.*')
 ...
 <div>
 <label for="video" class="block text-sm font-medium text-gray-400">Video (single)</label>
 <input id="video" name="video" type="file" accept="video/mp4,video/quicktime,video/webm" class="mt-1 block w-full text-sm text-gray-400">
 @error('video')
 <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
 @enderror
