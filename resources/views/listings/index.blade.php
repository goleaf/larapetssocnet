                                ...
                                <x-ui.dropdown align="right" width="48">
                                    ...
                                    <x-slot name="content">
                                        <div class="space-y-1 p-1 text-sm">
                                            <a href="{{ $showHref }}" class="block rounded-lg px-3 py-2 hover:bg-black/5 dark:hover:bg-white/5">View</a>

                                            @if (! $isDeleted && $editRouteName)
                                                <a href="{{ $editHref }}" class="block rounded-lg px-3 py-2 hover:bg-black/5 dark:hover:bg-white/5">Edit</a>
                                            @endif

                                            @if ($isDeleted && $restoreRouteName)
                                                <form method="POST" action="{{ route($restoreRouteName, $listingId ?: $listing) }}">
                                                    @csrf
                                                    <button type="submit" class="block w-full rounded-lg px-3 py-2 text-left hover:bg-black/5 dark:hover:bg-white/5">Restore</button>
                                                </form>
                                            @endif
                                            ...
                                            @if ($destroyRouteName)
                                                <button
                                                    type="button"
                                                    class="block w-full rounded-lg px-3 py-2 text-left hover:bg-black/5 dark:hover:bg-white/5"
