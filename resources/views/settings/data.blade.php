<x-settings-layout>
 ...
 <div>
 <h3 class="text-lg font-medium leading-6 text-gray-400">Download Your Data</h3>
 <p class="mt-1 text-sm text-gray-400">Get a copy of your content. We will prepare an archive containing your
 ...
 class="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-400 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
 Cancel
 </button>
 <button type="submit"
