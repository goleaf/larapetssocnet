<x-settings-layout>
 <div class="space-y-6">
 <div>
 <h3 class="text-lg font-medium leading-6 text-gray-400">Password</h3>
 <p class="mt-1 text-sm text-gray-400">Ensure your account is using a long, random password to stay secure.
 </p>
 </div>
 ...
 <h3 class="text-lg font-medium leading-6 text-gray-400">Security Information</h3>
 <dl class="mt-4 divide-y divide-gray-200">
 <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
 <dt class="text-sm font-medium text-gray-400">Last password change</dt>
 ...
 <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
 <dt class="text-sm font-medium text-gray-400">Active sessions</dt>
 <dd class="mt-1 text-sm text-gray-400 sm:col-span-2 sm:mt-0">
