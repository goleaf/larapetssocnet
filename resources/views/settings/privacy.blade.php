<x-settings-layout>
 <div class="space-y-6">
 <div>
 <h3 class="text-lg font-medium leading-6 text-gray-400">Privacy & Visibility</h3>
 <p class="mt-1 text-sm text-gray-400">Manage who can see your content and who can interact with you.</p>
 </div>
 ...
 <!-- Profile Visibility -->
 <div>
 <h4 class="text-sm font-medium text-gray-400">Profile Visibility</h4>
 <p class="text-sm text-gray-400 mb-4">Control who can view your posts and personal details.</p>
 ...
 <label for="pv_public" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Public <span class="font-normal text-gray-400">(Anyone can see your profile and
 posts)</span>
 </label>
 </div>
 <div class="flex items-center">
 ...
 <label for="pv_followers" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Followers Only <span class="font-normal text-gray-400">(Only approved followers can see
 ...
 <div>
 <h4 class="text-sm font-medium text-gray-400">Direct Messages</h4>
 <p class="text-sm text-gray-400 mb-4">Control who can send you direct messages.</p>
 ...
 <label for="mp_everyone" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Everyone
 </label>
 </div>
 <div class="flex items-center">
 ...
 <label for="mp_followers" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Followers Only
 </label>
 </div>
 </div>
 ...
 <!-- Pets Visibility -->
 <div>
 <h4 class="text-sm font-medium text-gray-400">Pets Visibility</h4>
 <p class="text-sm text-gray-400 mb-4">Control who can see the pets associated with your account.</p>
 ...
 <label for="pet_everyone" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Everyone
 </label>
 </div>
 <div class="flex items-center">
 ...
 <label for="pet_followers" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Followers Only
 </label>
 </div>
 </div>
 ...
 <!-- Groups Visibility -->
 <div>
 <h4 class="text-sm font-medium text-gray-400">Groups Visibility</h4>
 <p class="text-sm text-gray-400 mb-4">Control who can see the groups you have joined.</p>
 ...
 <label for="grp_everyone" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Everyone
 </label>
 </div>
 <div class="flex items-center">
 ...
 <label for="grp_followers" class="ml-3 block text-sm font-medium leading-6 text-gray-400">
 Followers Only
 </label>
 </div>
 </div>
