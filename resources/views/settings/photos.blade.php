<x-settings-layout>
 <div class="space-y-6">
 <div>
 <h3 class="text-lg font-medium leading-6 text-gray-400">Photo Galleries</h3>
 ...
 <div class="space-y-8">
 <section>
 <h4 class="text-sm font-semibold text-gray-400">Create new gallery</h4>
 ...
 <section>
 <h4 class="text-sm font-semibold text-gray-400">Your galleries</h4>
 ...
 <div class="min-w-0">
 <p class="truncate text-sm font-semibold text-gray-400">
 {{ $gallery->title }}
 </p>
 ...
 <span class="inline-flex items-center rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-400">
