<x-settings-layout>
 <div class="space-y-6">
 <div>
 <h3 class="text-lg font-medium leading-6 text-gray-400">Blocked Users</h3>
 <p class="mt-1 text-sm text-gray-400">When you block someone, they cannot view your profile, contact you, or
 see your posts.</p>
 </div>
 ...
 <div class="text-center py-6 text-gray-400 text-sm italic">You haven't blocked anyone.</div>
 @else
 <table class="min-w-full divide-y divide-gray-300">
 <thead>
 <tr>
 <th scope="col"
 class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-400 sm:pl-0">User
 </th>
 <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-400">Date
 Blocked</th>
 ...
 <div class="ml-4">
 <div class="font-medium text-gray-400">{{ $blockedUser->name }}</div>
 <div class="text-gray-400">{{'@'. $blockedUser->username }}</div>
 </div>
 </div>
 </td>
